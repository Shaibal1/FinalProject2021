...
//
//        Wait fWait = new FluentWait(DW.getDriver())
...
//        Actions act = new Actions(DW.getDriver());
...
//        JavascriptExecutor js = (JavascriptExecutor) DW.getDriver();
//        js.executeScript("scrollBy(0,"+pixels+")");
//    }
//
...
//        for (int i=0 ; i < 30 ; i++) {
//            try {
//                WebElement element = DW.getDriver().findElement(locator);
//                element.click();
//                break;
...
//        DW.getDriver().switchTo().window(newHandle);
//    }
//
//    /**
...
//        return DW.getDriver().getWindowHandles();
//    }
//
//    /**
...
//        return DW.getDriver().getWindowHandle();
//    }
//
//
//    /**
...
//        return DW.getDriver().switchTo().alert();
//    }
//
//    /**
...
//        DW.getDriver().switchTo().frame(frameId);
//    }
//
//    public void switchToFrame(WebElement frameElement) {
//        DW.getDriver().switchTo().frame(frameElement);
//    }
//
//
//
